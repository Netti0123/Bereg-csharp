        ...
        static void Main(string[] args)
        {
            ...
            switch (valasztas)
            {
                case 3:
                    ...
                    Console.WriteLine("A háromszög átlóinak hossza:" + haromszog(oldal1, oldal2, oldal3);
                    break;
                case 4:
                    ...
                    Console.WriteLine("A négyszög átlóinak hossza:", +negyszog(oldal4, oldal5, magassag);
                    break;
                case 5:
                    Console.WriteLine("Az ötszög átlóinak hossza nem kiszámítható.");
                    break;
                case 6:
                    Console.WriteLine("Adja meg a hatszög oldalainak hosszát:");
            ...
            double haromszog(double oldal1, double oldal2, double oldal3)
            {
                ...
                return 2 * area / oldal3;
            }

            double negyszog(double oldal4, double oldal5, double magassag)
            {
                return Math.Sqrt(oldal4 * oldal4 + oldal5 * oldal5 + 2 * magassag * magassag);
            }

            double hatszog(double oldal6)
            {
                return oldal6 * Math.Sqrt(3);
            }
        }
    }
}